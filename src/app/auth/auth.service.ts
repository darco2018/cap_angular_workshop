...
export class AuthService {
  ...
  //  making it easy to manage and propagate state changes.

  // Observable  might require // more boilerplate code to achieve similar functionality.
  ...
  private _isUserLoggedIn$ = new BehaviorSubject<boolean>(false); // needs to be initialized
